    ...
    public partial class initialMigrationAgain : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscribing", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Subscribing_Customers_CustomersId",
                        column: x => x.CustomersId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subscribing_ServicePlans_ServicePlansId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscribing_CustomersId",
                table: "Subscribing",
                column: "CustomersId");

            migrationBuilder.CreateIndex(
                name: "IX_Subscribing_ServicePlansId",
                table: "Subscribing",
